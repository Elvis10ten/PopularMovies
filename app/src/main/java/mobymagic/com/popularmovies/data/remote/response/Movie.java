package mobymagic.com.popularmovies.data.remote.response;
...
import mobymagic.com.popularmovies.utils.DateUtility;
...
public class Movie implements Parcelable {
    ...
    public String getReleaseYear(){
        ...
        if (!TextUtils.isEmpty(releaseDate)) {
            ...
            releaseYear = String.format(Locale.US, "%d", calendar.get(Calendar.YEAR));
        }
        return releaseYear;
    }
    ...
    public String getPosterUrl(){
        return String.format("%s%s%s", SECURE_BASE_URL, POSTER_SIZE, posterPath);
    }
